...
class KnnModel:
	...
	def train(self):
		...
		self.model = KNeighborsRegressor(n_neighbors=3,leaf_size=1)
		# self.model = GridSearchCV(KNeighborsRegressor(),param_grid={'n_neighbors': range(1,10),'leaf_size':range(1,30)},scoring='neg_mean_absolute_error',n_jobs=-1)
